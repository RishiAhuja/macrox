...
void getDependencies() {
  // // Register Appwrite as singleton
  // sl.registerLazySingleton<Appwrite>(() => Appwrite());
  // sl.registerLazySingleton<Account>(() => sl<Appwrite>().account);
  // sl.registerLazySingleton<Databases>(() => sl<Appwrite>().databases);

  // Register other services
  // sl.registerLazySingleton<AuthAppwriteService>(
  //   () => AuthAppwriteServiceImplementation(
  //       account: sl<Account>(), databases: sl<Databases>()),
  // sl.registerLazySingleton<AuthAppwriteService>(
  //   () => AuthAppwriteServiceImplementation(),
  // );
